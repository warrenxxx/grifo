 ...
 * @since :24/03/2018
 */
public class MetadateException extends BaseException {
    public MetadateException(String key, String value, String message) {
        super(
                new AppError()
                        .setParamKey(key)
                        .setParamValue(value)
                        .setErrorNameException(MetadateException.class.getSimpleName())
                        .setErrorMessageSystem(message)
        );
    }

    public MetadateException(Throwable t) {
        super(
                new AppError()
